...
/**
 * Analyzes an image URL to generate tags, vibe, and quality assessment.
 */
export const analyzeImage = async (imageUrl: string) => {
  ...
  try {
    ...
    const prompt = `Analyze this Instagram image. Respond ONLY with a single JSON object. Do not add markdown.
    The JSON must have this structure: { "tags": ["tag1"], "vibe": "...", "quality": { "lighting": "..." } }
    - "tags": 1-3 keywords from this list: ['food', 'travel', 'fashion', 'selfie', 'car', 'pet', 'fitness', 'nature', 'city', 'art', 'tech', 'lifestyle', 'product'].
